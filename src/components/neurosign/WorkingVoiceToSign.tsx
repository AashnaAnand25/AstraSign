...
import { Mic, Camera, Type, Settings, ChevronRight, ArrowLeft, MicOff } from "lucide-react";
...
export default function WorkingVoiceToSign({ onBack, onSettings, embedded = false }: Props) {
